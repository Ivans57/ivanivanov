...
$( document ).ready(function() {
    ...
    var button_update = document.querySelector('.admin-panel-keywords-create-edit-keyword-controls-button-update');
    ...
    button_update.onclick = function() {
        ...
        if (keyword_input.value === "" || text_input.value === "") {
            ...
            $.ajax({
                ...
                //We need to take url from attributes because we have two
                //localizations of the website.
                url: $('#admin_panel_create_keyword_form').attr('action'.keyword_input.value),
                data: {keyword: keyword_input.value, text: text_input.value}
            });
