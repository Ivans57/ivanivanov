...
class ArticlesRepository {
    ...
    private function article_code_processing($article_body_code){       
        ...
        //Adding smiley faces.
        $article_body_code = $this->add_smiley_faces($this->convert_bbcode_list($article_body_code));
              
        //Extracting from bbcode all images dimensions.
        $images_dimesions = $this->get_image_dimensions_from_bbcode($article_body_code);//Need to try to do this first!
        ...
        //$article_body_code = $this->html_processing($this->add_new_tags_to_bbcode_and_convert_to_html($article_body_code));
        
        //Function below is processing the html code with a special parser as there
        //some operations that cannot be done with simple php functions.
        $article_body_code = $this->html_processing_with_parser($this->html_processing($this->add_new_tags_to_bbcode_and_convert_to_html($article_body_code)), 
                                                                                        $images_dimesions);
